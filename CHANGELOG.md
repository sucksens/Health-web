...
- Error 500 en PATCH /adherence/{id} por columna taken_at demasiado corta (VARCHAR(30) → VARCHAR(50))
- Duplicacion de registros de adherencia por race condition al cargar la pagina (unique constraint agregado)
- Boton de notas disponible para registros en cualquier estado (taken, skipped, late)
- Sincronizacion de todayRecords y historyRecords al actualizar estado o notas
